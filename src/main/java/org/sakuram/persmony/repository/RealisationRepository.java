...
public interface RealisationRepository extends JpaRepository<Realisation, Long> {
	...
	@Query(nativeQuery = true, value =
			...
			+ " IT.id it_id, IT.transaction_type_fk, ttDV.value transaction_type, COALESCE(IT. accounted_transaction_date, IT.due_date) it_due_date, IT.due_amount, IT.interest_amount it_interest_amount, IT.tds_amount it_tds_amount, IT.accrual_tds_reference, IT.in_ais it_in_ais, IT.form26as_booking_date it_form26as_booking_date,"
